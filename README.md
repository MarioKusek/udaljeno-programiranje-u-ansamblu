...
Otići na stranicu repozitorija na GitHubu npr. [https://github.com/MarioKusek/ilj-tdd-template](https://github.com/MarioKusek/ilj-tdd-template) ili [https://github.com/MarioKusek/ilj-web-server-template](https://github.com/MarioKusek/ilj-web-server-template), kliknuti na **Use this template**, zatim upišemo za ime repozitorija koji ćemo stvoriti npr. `ilj-web-server`. Klik na **Create repository from template**.
